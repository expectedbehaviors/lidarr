...
<Config>
  ...
  <InstanceName>{{ $o.instanceName | default "Lidarr" }}</InstanceName>
  ...
  <PostgresMainDb>{{ $e.postgresMainDb | default "lidarr-main" }}</PostgresMainDb>
  <PostgresLogDb>{{ $e.postgresLogDb | default "lidarr-log" }}</PostgresLogDb>
